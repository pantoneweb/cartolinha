<footer class="footer">
                        ...
                        <div class="footer-text one">
                            ...
                            <ul>
                                <li><a href="#"><i class="material-icons">location_on</i>1 Street, derby, FL 2147,
                                        USA</a></li>
                                <li><a href="#"><i class="material-icons">email</i>cartolinha@gmail.com</a></li>
    ...
    <div class="footer_bottom">
        <p>Copyright @ 2017 <a href="#">Cartolinha</a> | Todos direitos reservados </p>
    </div>
</footer>